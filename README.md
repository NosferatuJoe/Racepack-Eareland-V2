# [Racepack] Eareland Races - Version: (1.0.4B)
...
- Go to csgo/cfg/source-python/wcs/ and open the file named: ```Racepack Eareland V2 - (Version 1.0.4B).ini```.
- Copy all the text and paste it in your races.ini file and restart your the server.
- NOTE! If you don't have a races.ini file already, then just change the name of the file from ```Racepack Eareland V2 - (Version 1.0.4B).ini``` to ```races.ini``` and then restart your server.
